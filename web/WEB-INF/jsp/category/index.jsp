                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col col-xs-6 ">
                                    <a href="category/insert.htm" class="btn btn-sm btn-primary btn-create">Thêm mới</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped table-bordered table-list">
                                ...
                                <tbody>
                                    <c:forEach var="u" items="${categorys}">
                                        <tr>
                                            <td align="center">
                                                <a class="btn btn-danger" href="category/delete.htm?categoryID=${u.categoryID}"><em class="fa fa-trash"></em></a>
                                            </td>
                                            
                                            <td align="center">
                                                <a class="btn btn-info" href="category/update.htm?categoryID=${u.categoryID}"><em class="fa fa-refresh"></em></a>
                                            </td>
                                            
                                            <td class="hidden-xs" align="center">${u.categoryID}</td>
                                ...
                                <div class="col col-xs-8">
                                    <ul class="pagination hidden-xs pull-right">
                                        ...
                                        <%
                                            if (trang > 1) {
                                        %>
                                        <li><a href="category/index.htm?page=<%=(trang - 1)%>">«</a></li>
                                            <%
                                                }
                                            %>
                                            <%
                                            ...
                                            %>
                                        <li <%if (trang == i) {%>class="active"<%}%>><a href="category/index.htm?page=<%=i%>"><%=i%></a></li>
                                            <%
                                                }
                                            %>
                                            <%
